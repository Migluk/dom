...
home2.addEventListener('click', () => {
    homeScore += 2;
    homeResultDOM.textContent = homeScore;
    historyDOM.insertAdjacentHTML('afterbegin', '<div class="entry home">Namų komanda pelnė 2 tašką.</div>');
});

home3.addEventListener('click', () => {
    homeScore += 3;
    homeResultDOM.textContent = homeScore;
    historyDOM.insertAdjacentHTML('afterbegin', '<div class="entry home">Nmaų komanda pelnė 3 tašką.</div>');
});
...
away2.addEventListener('click', () => {
    awayScore += 2;
    awayResultDOM.textContent = awayScore;
    historyDOM.insertAdjacentHTML('afterbegin', '<div class="entry away">Svečių komanda pelnė 2 tašką.</div>');
});

away3.addEventListener('click', () => {
    awayScore += 3;
    awayResultDOM.textContent = awayScore;
    historyDOM.insertAdjacentHTML('afterbegin', '<div class="entry away">Svečių komanda pelnė 3 tašką.</div>');
});